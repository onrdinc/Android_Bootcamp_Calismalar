...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tasarim.textViewSonuc.setText(String.valueOf(tasarim.slider.getProgress()));//sliderin anlık durumu
        ...
        tasarim.buttonSaat.setOnClickListener(view -> {
            ...
            },saat,dakika,true);//false dersek 12 saate göre gösterir
