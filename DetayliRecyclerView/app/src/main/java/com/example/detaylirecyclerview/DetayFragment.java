...
public class DetayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tasarim.ivFilmResim.setImageResource(getResources().getIdentifier
                (gelenFilm.getFilmResimAdi(),"drawable",requireContext().getPackageName()));
        ...
        tasarim.btnSepeteEkle.setOnClickListener(view -> {
            Snackbar.make(view,gelenFilm.getFilmAdi()+" "+gelenFilm.getFilmFiyat()+" ₺ fiyatla sepete eklendi",
