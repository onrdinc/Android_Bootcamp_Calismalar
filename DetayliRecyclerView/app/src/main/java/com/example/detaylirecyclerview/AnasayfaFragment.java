...
public class AnasayfaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Filmler f2 = new Filmler(1,"Django","django",2009,15.0,"Quentin Tarantino");
        Filmler f3 = new Filmler(1,"Inception","inception",2006,8.0,"Christopher Nolan");
        Filmler f4 = new Filmler(1,"Interstellar","interstellar",2013,18.0,"Christopher Nolan");
        Filmler f5 = new Filmler(1,"The Hateful Eight","thehatefuleight",2011,9.0,"Quentin Tarantino");
        Filmler f6 = new Filmler(1,"The Pianist","thepianist",2000,5.0,"Roman Polanski");
